...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  // پشتیبانی از هر دو ساختار قدیمی و جدید
  const displayName =
    ...
    <div className="flex min-h-screen bg-[#0F172A]" dir="rtl">
      <aside className="sticky top-0 flex h-screen w-60 flex-col border-l border-[#1E293B] bg-[#0F172A]">
        <div className="border-b border-[#1E293B] p-5">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#94A3B8]">CarSense</p>
            </div>
          </Link>
        </div>
        ...
        <nav className="flex-1 space-y-1 p-3">
          ...
          <Link
            to="/"
            className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-[#94A3B8] hover:bg-[#1E293B] hover:text-[#F8FAFC]"
          >
        ...
        <div className="border-t border-[#1E293B] p-3">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#EF4444]/30 bg-[#EF4444]/10 px-4 py-2.5 text-sm font-medium text-[#EF4444] hover:bg-[#EF4444]/20"
          >
